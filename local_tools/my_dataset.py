...
Liver Biopsy
'''
fibrosis_label = {"0": 0, "1": 1, '2':2, '3':3, '4':4, 'ignore':5,
                  '05':6, '10':7, '15':8,'20':9, '25':10, '30':11, '35':12, '40':13, '45':14,'50':15, '55':16, '60':17,'65':18,'70':19, '75':20,}
class LBDataset(Dataset):
    ...
    def get_img_info(data_dir):
        ...
        for root, dirs, _ in os.walk(data_dir):
            # 遍历类别
            for sub_dir in dirs:
                # if sub_dir != '0':# only read images of folder 1
                #     continue
                img_names = os.listdir(os.path.join(root, sub_dir))
